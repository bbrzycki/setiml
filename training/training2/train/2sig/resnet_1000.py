...
dense1 = Dense(2048, activation=activation)(dense0)
...
plot_model(model, to_file='2sig_%s_resnet_1000.png' % activation, show_shapes=True)

#################################################################

model_fn = dir_name + 'models/2sig/%s_resnet_1000.h5' % activation
history_fn = dir_name + 'models/2sig/%s_resnet_1000_history' % activation
