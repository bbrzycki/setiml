...
plot_model(model, to_file='2sig_%s_resnet.png' % activation, show_shapes=True)

#################################################################

model_fn = dir_name + 'models/2sig/%s_resnet_bright.h5' % activation
history_fn = dir_name + 'models/2sig/%s_resnet_bright_history' % activation
