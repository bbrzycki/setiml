...
class DataGenerator(keras.utils.Sequence):
    ...
    def __data_generation(self, list_IDs_temp):
        ...
        for i, ID in enumerate(list_IDs_temp):
            ...
            frame = np.stack([frame, frame], axis=1).reshape((64, 1024))            
...
plot_model(model, to_file='2sig_resnet_2chans_2xres.png', show_shapes=True)

#################################################################

model_fn = dir_name + 'models/2sig/relu_resnet_2chans_2xres.h5'
history_fn = dir_name + 'models/2sig/relu_resnet_2chans_2xres_history'
