...
plot_model(model, to_file='2sig_resnet_2chans.png', show_shapes=True)

#################################################################

model_fn = dir_name + 'models/2sig/relu_resnet_2chans_1000.h5'
history_fn = dir_name + 'models/2sig/relu_resnet_2chans_1000_history'
