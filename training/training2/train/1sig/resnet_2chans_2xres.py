...
plot_model(model, to_file='1sig_resnet_2chans_2xres.png', show_shapes=True)

#################################################################

model_fn = dir_name + 'models/1sig/relu_resnet_2chans_2xres.h5'
history_fn = dir_name + 'models/1sig/relu_resnet_2chans_2xres_history'
