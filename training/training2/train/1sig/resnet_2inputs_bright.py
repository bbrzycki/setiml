...
plot_model(model, to_file='1sig_resnet_2inputs.png', show_shapes=True)

#################################################################

model_fn = dir_name + 'models/1sig/resnet_2inputs_bright.h5'
history_fn = dir_name + 'models/1sig/resnet_2inputs_bright_history'
